...
export default function HeroSection() {
  ...
  return (
    ...
    bg-gradient-to-br from-white via-purple-50/40 to-green-50/40 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              bg-purple-100 text-purple-800 text-sm font-semibold rounded-full">
                Celebrating 5 Years
              </span>
            </motion.div>
          ...
          >
            ...
            shadow-2xl shadow-purple-900/20">
              ...
              bg-gradient-to-tr from-purple-600/20 to-green-600/20 z-10" />
